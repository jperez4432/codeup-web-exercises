...
var tipPercentage = parseFloat(prompt("What percentage would you like to tip? (In decimals please.)"));
var tipAmount = calculateTip(tipPercentage, bill);
var total = bill + tipAmount;
alert("Your bill came out to $" + bill.toFixed(2) + " You decided to tip a generous " + (tipPercentage * 100) + "%, which will result in $ " + tipAmount.toFixed(2) + " to be added to your final total. Your final total is: $" + total.toFixed((2) + "." ));
...
function applyDiscount(originalPrice, markDownPercentage) {
 ...
 /* git add ,
 git commit -m ' completed the function exercise
 git status
